...
package de.gematik.tim.test.glue.api.matrix.tasks;
...
public class CallMatrixApiTask implements Task, BuildWithUserAgent, WithHomeserverForwarding {
  ...
  public CallMatrixApiTask withRequestBody(String requestBody) {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    if (requestBody != null) {
      matrixApiCall.with(request -> request.body(requestBody));
    }
