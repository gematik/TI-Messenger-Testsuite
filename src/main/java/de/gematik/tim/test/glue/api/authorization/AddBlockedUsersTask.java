...
import static de.gematik.tim.test.glue.api.authorization.HasBlockAndAllowListAbility.addBlockedUsersToActor;
...
public class AddBlockedUsersTask implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    addBlockedUsersToActor(blockedUsersMxids, actor);
  }
}
