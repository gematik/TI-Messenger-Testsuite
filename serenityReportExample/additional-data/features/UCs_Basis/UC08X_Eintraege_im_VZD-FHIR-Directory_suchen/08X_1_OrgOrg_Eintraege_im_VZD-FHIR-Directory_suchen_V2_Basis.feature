# language: de
@File:FeatureFile_08X_01_V2_Basis @Ctl:UseCaseV2_08X_Basis @PRODUKT:TI-M_Client_Basis @Zul:Pro @Zul:ProKK @AFO-ID:A_25479 @AFO-ID:A_25428 @NB:JA
Funktionalität: 08X. (1) Einträge im VZD-FHIR-Directory suchen (Basis Spec)
  ...
  Inhalt
  TF 1     User sucht Healthcareservice im VZD
  TF 2     User sucht Healthcareservice teilqualifiziert im VZD

  @Ctl:AllowAll @Ctl:OrgAdmin @Ctl:VZD @TCID:TIM_V2_BASIS_AF_08X0101 @PRIO:1 @TESTFALL:Positiv @STATUS:Implementiert
  Szenariogrundriss: 08X.01.01 Einträge im VZD-FHIR-Directory suchen - AllowAll - Org-User sucht Healthcareservice im VZD
  ...
  @Ctl:AllowAll @Ctl:OrgAdmin @Ctl:VZD @TCID:TIM_V2_BASIS_AF_08X0102 @PRIO:1 @TESTFALL:Positiv @STATUS:Implementiert
  Szenariogrundriss: 08X.01.02 Einträge im VZD-FHIR-Directory suchen - AllowAll - Org-User sucht Healthcareservice teilqualifiziert im VZD
    Angenommen Es werden folgende Clients reserviert:
      | A | ORG_ADMIN  | <ApiName1A> |
      | B | PRO_CLIENT | <ApiName1B> |
      | C | PRO_CLIENT | <ApiName2>  |
