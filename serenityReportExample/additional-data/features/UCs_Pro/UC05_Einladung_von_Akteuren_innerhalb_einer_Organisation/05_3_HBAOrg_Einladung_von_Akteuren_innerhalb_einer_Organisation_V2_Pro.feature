# language: de
@File:FeatureFile_05_03_V2_Pro @Ctl:UseCaseV2_05_Pro @Ctl:OneHomeServer @PRODUKT:TI-M_Client_Pro @PRODUKT:TI-M_FD_Pro @PRODUKT:TI-M_Client_Basis @PRODUKT:TI-M_FD_Basis @Zul:Pro @AF-ID:AF_10104-03 @AFO-ID:A_25045-01 @AFO-ID:A_25046 @NB:JA
Funktionalität: 5.1.5 (3) Einladung von Akteuren innerhalb einer Organisation (Pro Spec)
  ...
  @Ctl:AllowAll @Ctl:VZD @Ctl:BP @TCID:TIM_V2_PRO_AF_050301 @PRIO:1 @TESTFALL:Positiv @STATUS:Implementiert
  Szenariogrundriss: 05.03.01 Einladung innerhalb einer Organisation - Chat - AllowAll - HBA User lädt anderen User ein
    ...
    @Plugin:Shuffle(true) @Plugin:EqualProperty(homeserver) @Plugin:AllowSelfCombine(true) @Plugin:AllowDoubleLineup(false) @Plugin:Filter(ApiName1A.hasTag("proClient")) @Plugin:Filter(ApiName1B.hasTag("proClient")) @Plugin:Filter(ApiName1A.hasTag("practitioner"))
    Beispiele:
      | ApiName1A             | ApiName1B             |
      | RU2-Ref-Pract-SDK-HS3 | RU2-Ref-Pract-SDK-HS3 |

  @Ctl:AllowAll @Ctl:VZD @Ctl:BP @TCID:TIM_V2_PRO_AF_050302 @PRIO:1 @TESTFALL:Positiv @STATUS:Implementiert
  ...
  @Ctl:BlockAll @Ctl:VZD @Ctl:BP @TCID:TIM_V2_PRO_AF_050303 @PRIO:1 @TESTFALL:Negativ @STATUS:Implementiert
  ...
  @Ctl:BlockAll @Ctl:VZD @Ctl:BP @TCID:TIM_V2_PRO_AF_050304 @PRIO:1 @TESTFALL:Negativ @STATUS:Implementiert
