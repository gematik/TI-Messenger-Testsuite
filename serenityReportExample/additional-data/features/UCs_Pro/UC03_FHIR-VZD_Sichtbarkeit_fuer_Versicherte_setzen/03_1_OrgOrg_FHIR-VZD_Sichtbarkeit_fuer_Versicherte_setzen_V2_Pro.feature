# language: de
@File:FeatureFile_03_01_V2_Pro @Ctl:UseCaseV2_03_Pro @PRODUKT:TI-M_Client_Pro @PRODUKT:TI-M_FD_Pro @Zul:Pro @Zul:ProKK @AF-ID:AF_10377 @AFO-ID:A_26172-01 @NB:JA
Funktionalität: 5.1.3 (1) FHIR-VZD Sichtbarkeit für Versicherte setzen (Pro Spec)
  ...
  @Ctl:AllowAll @Ctl:OrgAdmin @Ctl:VZD @TCID:TIM_V2_PRO_AF_030101 @PRIO:1 @TESTFALL:Positiv @STATUS:Implementiert
  Szenariogrundriss: 03.01.01 FHIR-VZD Sichtbarkeit für Versicherte setzen - AllowAll - HealthCare Service setzt seinen Status auf endpointVisibility auf hide-versicherte
    ...
    Und "A" sieht die endpointVisibility für die Endpunkt Extension von "B" im Healthcare-Service "HealthcareServiceName1" NICHT mehr auf dem Wert hide-versicherte [Retry 6 - 1]
    Dann "C" findet "B" im Healthcare-Service "HealthcareServiceName1"
