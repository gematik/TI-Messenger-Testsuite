# language: de
@File:FeatureFile_03_03_V2_Pro @Ctl:UseCaseV2_03_Pro @PRODUKT:TI-M_Client_Pro @PRODUKT:TI-M_FD_Pro @Zul:Pro @AF-ID:AF_10376 @AFO-ID:A_26172-01 @NB:JA
Funktionalität: 5.1.3 (3) FHIR-VZD Sichtbarkeit für Versicherte setzen (Pro Spec)
  ...
  @Ctl:AllowAll @Ctl:VZD @TCID:TIM_V2_PRO_AF_030301 @PRIO:1 @TESTFALL:Positiv @STATUS:Implementiert
  Szenariogrundriss: 03.03.01 FHIR-VZD Sichtbarkeit für Versicherte setzen - AllowAll - HBA User setzt seinen Status auf endpointVisibility auf hide-versicherte
    ...
    Und "A" sieht die eigene endpointVisibility der Practitioner Endpunkt Extension NICHT mehr auf dem Wert hide-versicherte [Retry 6 - 1]
    Und "B" findet "A" in FHIR
