...
[TIP]
[black]#*_Grundsätzlich müssen an jeder Schnitttelle mindestens drei Gräte zur Verfügung stehen (z.B. 3 x IOS Clients usw.).
Ausgenommen von dieser Festlegung ist der Org-Admin, hier ist ein Geräte ausreichend._*#

[TIP]
[black]#*_Kartenbestellung über das gematik Fachportal: +
