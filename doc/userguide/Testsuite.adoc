...
Die unterschiedlichen Testtreibeschnittstellen werden mit mTLS gesichert. Eine unterstützende Anleitung hierzu befindet sich link:GettingStarted.adoc#_zertifikate_einrichten[hier].
...
[TIP]
[black]#*_Jeder Hersteller muss an jeder zum Testlauf gehörigen Instanz mindestens einen Client mit HBA Funktionalität mit den 'prefIOP' Tag in der combine_items.json versehen. Nur so ist gewährleistet, dass für alle Testfälle die entsprechenden Kombinationen gebildet werden können._*#
...
|00.02| Abfragen der Schnittstellen-Information durch Organisations-User-Client
|00.03| Abfragen der Schnittstellen-Information durch Org-Admin-Client
|00.04| Abfragen der Geräte-Liste durch HBA-User-Client
|00.05| Abfragen der Geräte-Liste durch Organisations-User-Client
|00.06| Abfragen der Geräte-Liste durch Org-Admin-Client
|===
...
|03.02| Organisationsressourcen im Verzeichnisdienst hinzufügen - Healthcare-Service durch Org-Admin anlegen und Endpoint ändern
...
|04.02| Anmeldung eines Akteurs - Erfolgreiche Anmeldung eines Akteurs (OrgUser)
|04.03| Anmeldung eines Akteurs - Erfolgreiche Anmeldung eines Akteurs (OrgAdmin)
|===
