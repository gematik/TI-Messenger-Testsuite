...
The report is not always up to date and complete, although we strive to keep it up to date and complete.

This is the command we used to create the example Serenity report:

[source,shell]
----
mvn -P oneonly,prod,dont-break-preparation -DpoolGroupString=RU1 -Dcucumber.filter.tags=@Zul:Pro --no-transfer-progress
----
