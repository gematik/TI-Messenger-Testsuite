...
= TI-Messenger Testsuite - Testset V2
...
[IMPORTANT]
====
Dieses Dokument ist als Erweiterung und Ergänzung zur bestehenden link:Testsuite.adoc[Testsuite] zu verstehen und baut auf den bereits etablierten Informationen und Grundlagen auf.
...
In den nachfolgenden Kapiteln finden Sie sämtliche zusätzliche Informationen zu den bereitgestellten Testfällen sowie zur Funktionalität des *Testset Version 2* für den TI-Messenger.
...
Hier werden ausschließlich zusätzliche Punkte behandelt, die speziell das Testset in der Version 2 betreffen.
...
Das TI-Messenger *Testset V2* ist ab folgenden Spezifikations- und Produkttypsteckbriefversionen gültig:
...
| Pro KK              | Basis Spec 1.0.0 & Pro Spec 1.0.0          | Client 1.0.0-0 & Fachdienst 1.0.0-0
...
| @NB:ONEONLY     | Testfälle die die gematik als Nebenbestimmungen akzeptieren kann (nur für Krankenkassen), wenn nachgewiesen werden kann,
...
In folgenden Listen sind alle Feature Files und die in den Tests behandelten AFOs aufgeführt.
...
[TIP]
[black]#*Diese erweiterte Dokumentation zum Testset V2 und die link:Testsuite.adoc[Testsuite.adoc] Dokumentation müssen in Kombination von Herstellern beachtet werden.*#
